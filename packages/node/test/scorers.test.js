...
describe('Scorers Registry', () => {
  test('should have all 36 scorers (5 axioms x 7 + NON_EXTRACTIVE alias)', () => {
    const expected = [
      'COHERENCE', 'HARMONY', 'STRUCTURE', 'ELEGANCE', 'COMPLETENESS', 'PRECISION', 'PROPORTION',
      'ACCURACY', 'VERIFIABILITY', 'TRANSPARENCY', 'REPRODUCIBILITY', 'PROVENANCE', 'INTEGRITY', 'CONSENSUS',
      'AUTHENTICITY', 'RELEVANCE', 'NOVELTY', 'ALIGNMENT', 'IMPACT', 'RESONANCE', 'LINEAGE',
      'UTILITY', 'SUSTAINABILITY', 'EFFICIENCY', 'VALUE_CREATION', 'SACRIFICE', 'NON_EXTRACTIVE', 'CONTRIBUTION', 'IRREVERSIBILITY',
      'COMMITMENT', 'ATTUNEMENT', 'CANDOR', 'CONGRUENCE', 'ACCOUNTABILITY', 'VIGILANCE', 'KENOSIS',
    ];
