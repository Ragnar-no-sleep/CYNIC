  ...
  packages: {
    core: {
      ...
      modules: {
        ...
        identity: { status: 'COMPLETE', exports: ['IDENTITY', 'TRAITS', 'VOICE', 'VERDICTS', 'FOUR_DOGS'] },
    ...
    node: {
      ...
      modules: {
        ...
        agents: {
          status: 'COMPLETE',
          exports: ['Observer', 'Digester', 'Guardian', 'Mentor'],
          v2: ['CollectiveGuardian', 'CollectiveAnalyst', 'CollectiveScholar', 'CollectiveArchitect', 'CollectiveSage'],
        },
